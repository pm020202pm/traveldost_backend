...
const createRequest=async (req, res)=>{
    ...
    try{
        const query=`INSERT INTO requests (user_id, time, date, vehicle, from_place, to_place, message) VALUES (?, ?, ?, ?, ?, ?, ?)`;
        await db.execute(query, [user_id, time, date, vehicle, from, to, message]);
